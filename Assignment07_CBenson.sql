...
-- 2020-02-28,CBenson,Completed File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_CBenson')
	 Begin 
	  Alter Database [Assignment07DB_CBenson] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_CBenson;
	 End
	Create Database Assignment07DB_CBenson;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_CBenson;
...
Select 
	c.CategoryName, 
	p.ProductName, 
	UnitPrice = FORMAT (p.UnitPrice, 'c')
...
GO
CREATE -- DROP
Function fProductInventoriesWithPreviousMonthCountsWithKPIs (@KPIVal int)
Returns TABLE
	AS
		Return Select
			ProductName,
		...
		WHERE [CountVsPreviousCountKPI] = @KPIVal;
GO
